# 1 "c:\\users\\dell\\documents\\vugen\\scripts\\book1tickcancelrandtick\\\\combined_Book1TickCancelRandTick.c"
...
# 1 "c:\\users\\dell\\documents\\vugen\\scripts\\book1tickcancelrandtick\\\\combined_Book1TickCancelRandTick.c" 2
...
# 2 "c:\\users\\dell\\documents\\vugen\\scripts\\book1tickcancelrandtick\\\\combined_Book1TickCancelRandTick.c" 2
...
# 3 "c:\\users\\dell\\documents\\vugen\\scripts\\book1tickcancelrandtick\\\\combined_Book1TickCancelRandTick.c" 2
...
# 4 "c:\\users\\dell\\documents\\vugen\\scripts\\book1tickcancelrandtick\\\\combined_Book1TickCancelRandTick.c" 2

# 1 "BookTicket.c" 1
BookTicket()
{
	int num,smallest,i,xyz;
	char Tmp[255];
	char *small;
	...
	web_reg_save_param("cFlightCost","LB=outboundFlight\" value=\"","RB=;02/05/2019","saveoffset=4","Ord=ALL","LAST");
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=outboundFlight", "Value=240;157;01/23/2019", "ENDITEM", 
		"Name=numPassengers", "Value=1", "ENDITEM", 
		"Name=advanceDiscount", "Value=0", "ENDITEM", 
		"Name=seatType", "Value=Business", "ENDITEM", 
		"Name=seatPref", "Value=Window", "ENDITEM", 
	...
	num=atoi(lr_eval_string("{cFlightCost_count}"));
	 
	smallest=atoi(lr_paramarr_idx("cFlightCost",1));

   for (i = 2; i <= num; i++) {
 
   	if (atoi(lr_paramarr_idx("cFlightCost",i)) < smallest) {
   		smallest = atoi(lr_paramarr_idx("cFlightCost",i));
      }
   }

  lr_output_message("Cheapest Flight  %d ",smallest);
  itoa(smallest,Tmp,10);
  lr_save_string(Tmp,"LowestFlight");
	...
	web_submit_data("reservations.pl_3", 
		...
		"Name=seatType", "Value=Business", "ENDITEM", 
		"Name=seatPref", "Value=Window", "ENDITEM", 
		"Name=outboundFlight", "Value=243;{LowestFlight};02/05/2019", "ENDITEM", 
		"Name=advanceDiscount", "Value=0", "ENDITEM", 
...
# 5 "c:\\users\\dell\\documents\\vugen\\scripts\\book1tickcancelrandtick\\\\combined_Book1TickCancelRandTick.c" 2
...
# 6 "c:\\users\\dell\\documents\\vugen\\scripts\\book1tickcancelrandtick\\\\combined_Book1TickCancelRandTick.c" 2
...
# 7 "c:\\users\\dell\\documents\\vugen\\scripts\\book1tickcancelrandtick\\\\combined_Book1TickCancelRandTick.c" 2
