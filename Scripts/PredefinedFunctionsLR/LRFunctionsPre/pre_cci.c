# 1 "c:\\users\\dell\\documents\\vugen\\scripts\\predefinedfunctionslr\\lrfunctionspre\\\\combined_LRFunctionsPre.c"
...
# 1 "c:\\users\\dell\\documents\\vugen\\scripts\\predefinedfunctionslr\\lrfunctionspre\\\\combined_LRFunctionsPre.c" 2
...
# 2 "c:\\users\\dell\\documents\\vugen\\scripts\\predefinedfunctionslr\\lrfunctionspre\\\\combined_LRFunctionsPre.c" 2
...
# 3 "c:\\users\\dell\\documents\\vugen\\scripts\\predefinedfunctionslr\\lrfunctionspre\\\\combined_LRFunctionsPre.c" 2
...
# 4 "c:\\users\\dell\\documents\\vugen\\scripts\\predefinedfunctionslr\\lrfunctionspre\\\\combined_LRFunctionsPre.c" 2
...
Action()
{
    ...
    lr_log_message("Hi i am log message");  
...
lr_vuser_status_message("we are on iteration # %s",lr_eval_string("{iteration}"));
    ...
    lr_save_datetime("Tomorrow is %B %d %Y", 0 + 86400, "next"); 
    lr_output_message(lr_eval_string("{next}"));
    
     lr_save_datetime("Yesterday is %Y-%m-%d", 0 - 86400, "next"); 
    lr_output_message(lr_eval_string("{next}"));
    	
    	 lr_save_datetime("Current is %d %m %Y", 0, "next"); 
    lr_output_message(lr_eval_string("{next}"));
...
# 5 "c:\\users\\dell\\documents\\vugen\\scripts\\predefinedfunctionslr\\lrfunctionspre\\\\combined_LRFunctionsPre.c" 2
...
# 6 "c:\\users\\dell\\documents\\vugen\\scripts\\predefinedfunctionslr\\lrfunctionspre\\\\combined_LRFunctionsPre.c" 2
