...
/*Correlation comment - Do not change!  Original value='125217.519724585zttAiHzpVHAiDDDDDiztfpcfHAcf' Name ='userSession' Type ='Manual'*/
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=outboundFlight", "Value=121;343;12/27/2018", ENDITEM, 
		"Name=numPassengers", "Value=1", ENDITEM, 
		"Name=advanceDiscount", "Value=0", ENDITEM, 
		"Name=seatType", "Value=Business", ENDITEM, 
		"Name=seatPref", "Value=Window", ENDITEM, 
