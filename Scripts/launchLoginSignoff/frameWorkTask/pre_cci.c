# 1 "c:\\users\\dell\\documents\\vugen\\scripts\\launchloginsignoff\\frameworktask\\\\combined_frameWorkTask.c"
...
# 1 "c:\\users\\dell\\documents\\vugen\\scripts\\launchloginsignoff\\frameworktask\\\\combined_frameWorkTask.c" 2
...
# 2 "c:\\users\\dell\\documents\\vugen\\scripts\\launchloginsignoff\\frameworktask\\\\combined_frameWorkTask.c" 2
...
# 3 "c:\\users\\dell\\documents\\vugen\\scripts\\launchloginsignoff\\frameworktask\\\\combined_frameWorkTask.c" 2
...
# 4 "c:\\users\\dell\\documents\\vugen\\scripts\\launchloginsignoff\\frameworktask\\\\combined_frameWorkTask.c" 2
...
web_url("webtours", 
	...
	if(strcmp("0",lr_eval_string("{txtchk}"))==0){
		...
		lr_end_transaction(lr_eval_string("Launch_{puser}"), 1);

		
		
	}else{
		lr_output_message("txtchk Passed");
		lr_end_transaction(lr_eval_string("Launch_{puser}"), 0);	
	}
...
login(){
	...
	if(strcmp("0",lr_eval_string("{txtchk1}"))==0){
		...
		lr_end_transaction(lr_eval_string("Login_{puser}"), 1);
		...
		lr_end_transaction(lr_eval_string("Login_{puser}"), 0);
	}
...
logoff(){
	...
	if(strcmp("0",lr_eval_string("{txtchk3}"))==0){
		...
		lr_end_transaction(lr_eval_string("Logoff_{puser}"), 1);
	}else{
		lr_output_message("txtchk3 Passed");
		lr_end_transaction(lr_eval_string("Logoff_{puser}"), 0);
	}
...
# 5 "c:\\users\\dell\\documents\\vugen\\scripts\\launchloginsignoff\\frameworktask\\\\combined_frameWorkTask.c" 2
...
# 6 "c:\\users\\dell\\documents\\vugen\\scripts\\launchloginsignoff\\frameworktask\\\\combined_frameWorkTask.c" 2
